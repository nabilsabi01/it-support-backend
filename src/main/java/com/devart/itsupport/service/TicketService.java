...
public class TicketService {
    ...
    public TicketDTO createTicket(TicketDTO ticketDTO) {
        ...
        ticket.setStatus(TicketStatus.valueOf(String.valueOf(TicketStatus.OPEN)));
...
//        User user = ticketMapper.toEntity((TechnicianDTO)).getUser();
...
//        Technician technician = ticketMapper.toEntity(technicianDTO);
